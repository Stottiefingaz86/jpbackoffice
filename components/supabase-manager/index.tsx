    ...
    <div className="grid grid-cols-[240px_1fr] h-full overflow-hidden">
      ...
      <div className="flex flex-col border-r px-3 py-6 pb-3">
        ...
        <footer className="p-0 text-sm text-muted-foreground flex items-center gap-3 -m-3 border-t">
          <HoverCard>
            <HoverCardTrigger render={<Link href={`https://supabase.com/dashboard/project/${projectRef}`} target="_blank" className="flex items-center px-4 w-full rounded-none text-sm py-4 h-auto justify-start gap-3 text-sm text-left hover:bg-accent" />}><LogoSupabase size={16} /><span className="flex-1">Open in Supabase</span><ExternalLink className="ml-2 h-4 w-4 text-muted-foreground/50" /></HoverCardTrigger>
            <HoverCardContent
              sideOffset={8}
              align="start"
              side="top"
